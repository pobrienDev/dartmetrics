  ...
  return (
    <div className="flex min-h-screen">
      <aside className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-ink-900 p-10 lg:flex">
        ...
        <p className="text-xs text-ink-500">Play a friend, a guest, or one of five bots.</p>
        <Dartboard className="absolute -right-24 top-1/2 h-[34rem] w-[34rem] -translate-y-1/2 opacity-90" />
      </aside>
